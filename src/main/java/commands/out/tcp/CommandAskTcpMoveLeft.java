...
public class CommandAskTcpMoveLeft extends CommandTCP {

    public CommandAskTcpMoveLeft(PrintWriter pw) {
        super(pw);
    }
    ...
    public void execute(ClientTCP clientTCP, String[] args) {
        DebugLogger.print(DebugType.CONFIRM, "COMMAND : LEMOV");
